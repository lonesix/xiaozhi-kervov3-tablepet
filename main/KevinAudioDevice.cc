...
KevinAudioDevice::KevinAudioDevice() {
}
...
void KevinAudioDevice::Initialize() {
...
void KevinAudioDevice::CreateDuplexChannels() {
    duplex_ = true;
...
int KevinAudioDevice::Write(const int16_t* data, int samples) {
...
int KevinAudioDevice::Read(int16_t* dest, int samples) {
    size_t bytes_read;
...
// void KevinAudioDevice::OnInputData(std::function<void(const int16_t*, int)> callback) {
//     on_input_data_ = callback;
// }

// void KevinAudioDevice::OutputData(std::vector<int16_t>& data) {
//     Write(data.data(), data.size());
// }

// void KevinAudioDevice::InputTask() {
//     int duration = 20;
